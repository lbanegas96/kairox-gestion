...
**Última actualización:** 2026-06-17 (sesión 19) — Unidades de Medida Parte 2: FK `productos.unidad_medida_id` (migration 045, 11/11 productos auto-mapeados), Select conectado en `ProductosSection` (con default automático a "Unidad" en alta y aviso de valor histórico no mapeado en edición), y migrados los 2 dropdowns hardcodeados duplicados que quedaban (`OrdenesCompraSection`, `CotizacionesSection`) para leer de la tabla `unidades_medida` en vez de listas de `<option>` copiadas a mano.
...
11. ⏳ **Membresías** / Modelo de licencias Starter/Pro/Business
