...
**Última actualización:** 2026-06-22 (sesión 51, Luciano) — Fase 2 de tests: efectos colaterales de `crear_venta` (caja/cuenta corriente/entrega) cubiertos, 10/10 verde. Además: se encontró y corrigió una regresión real en los 9 tests de Fase 1 (colisión de PK con el trigger `on_auth_user_created`) — los 9 vueltos a correr de punta a punta, todos en verde tras el fix.
