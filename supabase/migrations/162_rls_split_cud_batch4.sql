...
BEGIN
  FOR pol IN
    ...
    WHERE p.schemaname = 'public'
      ...
      AND p.tablename = ANY(ARRAY['facturas_proveedor','lista_precio_items','listas_precio','metodo_pago_cuenta_bancaria','movimientos_bancarios','movimientos_caja','ofertas','ordenes_compra'])
      AND EXISTS (
