-- Fase 1 del plan de 4 frentes contables agregó centro_costo_id a comprobantes
-- (migration 168), pero crear_venta nunca lo recibió como parámetro — el
-- selector de Centro de Costo en NuevaVentaModal.jsx (POS) no tenía forma de
-- persistir el valor elegido. CREATE OR REPLACE no alcanza para agregar un
-- parámetro nuevo (lección de sesiones previas) → DROP explícito primero.
