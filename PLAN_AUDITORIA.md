...
**Última actualización:** 2026-07-03 (sesión 46 cont. 4 — Cotizaciones/Pedidos auditada; área #12)
...
### 🔄 En curso
_(ninguna ahora — próxima: #13 de la cola = Comprobantes — lifecycle)_
...
| 13 | **Comprobantes — lifecycle** ← próxima | `comprobantes` (NC emitida, anulación) | D·A | Anulación de facturas; NC; ¿revierte asiento/stock? |
