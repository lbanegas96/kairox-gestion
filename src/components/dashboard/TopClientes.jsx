      ...
      {topLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
          {topClientes.map((c, i) => {
            ...
            return (
              // key por posición, no por nombre: dos clientes distintos pueden compartir
              // nombre a propósito (ej. "Consumidor Final" real + ventas sin cliente
              // identificado, agrupadas aparte — ver dashboardService.ts) y la lista no se
              // reordena por interacción del usuario, así que el índice es estable.
              <div key={i} className="bg-kx-surface-2 rounded-xl p-2.5 border border-kx-border">
