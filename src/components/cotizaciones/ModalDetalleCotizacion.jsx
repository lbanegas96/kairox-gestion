...
import { FileText, CheckCircle, Download, Loader2, Send, PackageCheck, AlertTriangle } from 'lucide-react';
...
function ModalDetalleCotizacion({ viewId, setViewId, detalle, onCopiarAPedido, onVerPedido }) {
  const { user } = useAuth();
