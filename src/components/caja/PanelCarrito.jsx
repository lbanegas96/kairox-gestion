...
function CarritoItem({ item, onModificar, onEliminar }) {
  return (
    <div className="flex items-center gap-2 bg-kx-surface-2 rounded-xl px-3 py-2">
      ...
      <div className="w-20 text-right flex-shrink-0">
        <span className="text-sm font-bold text-kx-text tabular-nums">
...
function PanelCarrito({ carrito, onModificarCarrito, onVentaExitosa }) {
  const { user }    = useAuth();
  ...
  const isCC = metodo === 'Cuenta Corriente';
