import { Send, CheckCircle, Clock, AlertCircle, XCircle, Receipt } from 'lucide-react';
...
export const ESTADOS = {
  ...
  // mig.332 — solo cuando TODOS los ítems quedaron 100% facturados (facturación
  // parcial de OC, estilo SAP); una NC de proveedor puede volver a 'recibida'.
  facturada:        { label: 'Facturada',         color: 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300', icon: Receipt },
